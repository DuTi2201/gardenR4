  ...
  const handleSendBulkNotification = async () => {
    try {
      ...
      await api.post(`admin/notifications/bulk-send`, {
        ...
        emailFrom: 'greenaigarden@gmail.com'
      });
      
      setOpenNotificationDialog(false);
      setSuccess(`Đã gửi thông báo tới ${userIds.length} người dùng`);
    } catch (err) {
                          ...
                          <TableCell align="right">
                            <Tooltip title="Thay đổi quyền">
                              <IconButton 
                                ...
                                disabled={user._id === (localStorage.getItem('user') ? JSON.parse(localStorage.getItem('user'))._id : null)}
                              >
                                <EditIcon />
                              </IconButton>
                            </Tooltip>
